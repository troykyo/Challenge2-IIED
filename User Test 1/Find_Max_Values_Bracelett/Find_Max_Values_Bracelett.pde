...
void setup() {
  ...
  saveTable(maxTable, "/Users/troy/Google Drive/TUe/Insights into Expirimental Data/Challenge2-IIED/Challenge2-IIED/User Test 1/NewMaxGroomed"+file);
}
