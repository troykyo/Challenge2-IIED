...
finalTable.addColumn("Voltage");
  finalTable.addColumn("Stiffness");
  finalTable.addColumn("Button");
  finalTable.addColumn("Pressure");
  finalTable.addColumn("Sex");
  finalTable.addColumn("Pref");
  finalTable.addColumn("Pref2");
